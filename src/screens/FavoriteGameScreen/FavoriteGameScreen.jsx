...
import "./FavoriteGameScreen.scss"
const FavoriteGameScreen = () => {
    const favoriteGame = useSelector(state => state.games.favoriteGame)
    const render = favoriteGame.length === 0 ?
    (<div className="boughtgame-loading">
        <h3>THERE ARE NO FAVORITE GAMES YET</h3>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="boughtgame-main">
                            <div className="title-general"><h2>FAVORITE GAME</h2></div>
...
export default FavoriteGameScreen;